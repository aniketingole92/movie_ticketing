...
$query=mysqli_query($con,"insert into categories(category_name, tax_rate, added_by ) values('$category','$trate','$addedby')");
if($query){
...
<head>
  ...
  <title>Billing System  | Categories</title>
...
<!-- Sub admin Contact Number---->
                  <div class="form-group">
                    <label for="text">Tax Rate</label>
                    <input type="number" class="form-control" id="taxrate" name="taxrate" placeholder="Enter tax rate" step="0.01"  title="Decimaal values ex: 1.00" required >
                  </div>
