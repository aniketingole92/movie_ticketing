...
$rid=intval($_GET['said']);
$query=mysqli_query($con,"delete from products where id='$rid'");
if($query){
...
<head>
  ...
  <title>Billing System  | Manage Products</title>
    ...
    <tbody>
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        echo "<tr>
          ...
          <td><a href='view_bill.php?bid={$row['id']}'>View</a></td>
        </tr>";
      }
      ?>
    </tbody>
